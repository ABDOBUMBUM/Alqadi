    ...
    >
      ...
      <section className="relative overflow-hidden py-24 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6">
          <p className="text-xs tracking-[0.4em] text-gold-400">GOLDEN AL&apos;QADI GROUP — SINCE 1980</p>
          <h1 className="mt-4 text-5xl font-black md:text-7xl" style={{ color: "var(--page-text)" }}>
            Travel in{" "}
            <span className="text-gold-gradient">Golden Style</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg" style={{ color: "var(--page-text-muted)" }}>
            Kuwait&apos;s premier travel, tourism, and manpower group — delivering luxury experiences across the Gulf and beyond for over 45 years.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              href="https://api.whatsapp.com/send?phone=96598765432&text=Hello, I would like to inquire about your services"
      ...
      <section className="py-20" style={{ background: "var(--section-alt-bg)" }}>
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              <p className="text-xs tracking-[0.35em] text-gold-400">WHY GOLDEN AL&apos;QADI</p>
              <h2 className="mt-4 text-3xl font-bold md:text-4xl" style={{ color: "var(--page-text)" }}>
                45 Years of Trust
              </h2>
              <p className="mt-4 leading-relaxed" style={{ color: "var(--page-text-muted)" }}>
                Founded in 1980, Golden Al&apos;Qadi Group has grown to become Kuwait&apos;s most trusted travel and manpower company, serving over 860,000 clients across the Gulf region.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: Globe2, label: "75+ Countries" },
                { icon: Users, label: "10K+ Corporate Clients" },
      ...
      <section className="mx-auto max-w-4xl px-6 py-20 text-center">
        <div className="rounded-3xl border p-10" style={{ borderColor: "rgba(201,162,39,0.25)", background: "linear-gradient(90deg, rgba(201,162,39,0.12) 0%, transparent 70%)" }}>
          ...
          <p className="mt-3" style={{ color: "var(--page-text-muted)" }}>
            Contact our team and get personalized travel solutions within minutes.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a href="https://api.whatsapp.com/send?phone=96598765432&text=Hello, I need travel assistance"
