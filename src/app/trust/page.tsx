...
export default function TrustPage() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-24">
      ...
      <h1 className="mt-6 text-3xl font-bold">مركز الشفافية</h1>
      <p className="mt-4 text-muted">
        سياسات، تراخيص، وشهادات — حدّث التواريخ والأرقام من مصدركم الرسمي.
      </p>
      <section className="mt-10 space-y-6 rounded-2xl border border-gold-500/20 bg-bg-panel/50 p-6">
        <h2 className="text-lg font-semibold text-gold-400">سجل أصول ثلاثية الأبعاد</h2>
